package com.lixinxinlove.camerademo.fragment;
...
import com.lixinxinlove.camerademo.AutoFitTextureView;
import com.lixinxinlove.camerademo.R;
...
public class Camera2VideoFragment  extends Fragment
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        //SDK
        EffectHelper mEffectHelper = new EffectHelper(getActivity(), EffectManager.EffectType.PREVIEW);
        mEffectHelper.init();


        HandDetect handDetect=new HandDetect();
      //  handDetect.createHandle(getActivity(),)
