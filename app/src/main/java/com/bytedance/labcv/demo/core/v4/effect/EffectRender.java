...
import com.bytedance.labcv.demo.opengl.ProgramManager;
...
public class EffectRender implements TextureFormatter {
    ...
    public void drawFrameOnScreen(int textureId,BytedEffectConstants.TextureFormat srcTetxureFormat,int textureWidth, int textureHeight,  int rotation, boolean flipHorizontal, boolean flipVertical) {
        ...
        if (rotation % 180 == 90){
             GlUtil.getShowMatrix(mMVPMatrix,GlUtil.TYPE_CENTERCROP, textureHeight, textureWidth, mSurfaceWidth, mSurfaceHeight);


        }else {
             GlUtil.getShowMatrix(mMVPMatrix,GlUtil.TYPE_CENTERCROP, textureWidth, textureHeight, mSurfaceWidth, mSurfaceHeight);
    ...
    public void drawFrameCentnerInside(int textureId, BytedEffectConstants.TextureFormat srcTetxureFormat, int textureWidth, int textureHeight){
        if (null == mProgramManager) {
            mProgramManager = new ProgramManager();
        }
        Matrix.setIdentityM(mMVPMatrix, 0);
...
//        mMVPMatrix=  GlUtil.changeMVPMatrixInside(mSurfaceWidth, mSurfaceHeight, textureWidth, textureHeight);
        GlUtil.getShowMatrix(mMVPMatrix,GlUtil.TYPE_CENTERINSIDE, textureWidth, textureHeight, mSurfaceWidth, mSurfaceHeight);
