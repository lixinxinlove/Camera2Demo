...
public interface ItemGetContract {
    ...
    // 风格妆
    int TYPE_STYLE_MAKEUP           = 5 << OFFSET;
    // Filter 滤镜
    int TYPE_FILTER                 = 6 << OFFSET;
    ...
    // Makeup 美妆
    int TYPE_MAKEUP_LIP = TYPE_MAKEUP + (1 << SUB_OFFSET);
    int TYPE_MAKEUP_BLUSHER = TYPE_MAKEUP + (2 << SUB_OFFSET);
    int TYPE_MAKEUP_EYELASH = TYPE_MAKEUP + (3 << SUB_OFFSET);
    int TYPE_MAKEUP_PUPIL = TYPE_MAKEUP + (4 << SUB_OFFSET);
    int TYPE_MAKEUP_HAIR = TYPE_MAKEUP + (5 << SUB_OFFSET);
    int TYPE_MAKEUP_EYESHADOW = TYPE_MAKEUP + (6 << SUB_OFFSET);
    int TYPE_MAKEUP_EYEBROW = TYPE_MAKEUP + (7 << SUB_OFFSET);
    int TYPE_MAKEUP_FACIAL = TYPE_MAKEUP + (8 << SUB_OFFSET);
    ...
    abstract class Presenter extends BasePresenter<View> {
        ...
        public abstract List<EffectButtonItem> allItems();
    }
}
