...
void main() {
    ...
    else if(u_digitNum == 3){
         if (base_coord.x < 0.3333) {
            data = third;
            base_coord.x = base_coord.x * 3.0;
        } 
        else if(base_coord.x < 0.6667 && base_coord.x >= 0.3333){
             data = second;
            base_coord.x = (base_coord.x - 0.3333) * 3.0;
        }
        else{
            data = first;
            base_coord.x = (base_coord.x - 0.6667) * 3.0;
        }
    } else if(u_digitNum == 1){
        data = first;
    }   
